...
func main() {
	...
	log.Println("Starting web server at 0.0.0.0:7070")
	//srv := http.Server{Addr: "0.0.0.0:7070", Handler: nil}
	srv := http.Server{Addr: "0.0.0.0:7070"}
