...
func main() {
	// Header length (measured in 32-bit words) is s
	...
	// Full header -> prints [1010000 00000010]
	fmt.Printf("%08b\n", b)

	// We are only interated if a TCP SYN flag has been set
