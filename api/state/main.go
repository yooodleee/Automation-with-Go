...
import (
	...
	"net/http"
	"reflect"
	eosAPI "github.com/yooodleee/Automation-with-Go/api/restconf/pkg/eos"
	"sync"

	srlAPI "github.com/yooodleee/Automation-with-Go/api/json-rpc/pkg/srl"
...
func (r CVX) GetRoutes(wg *sync.WaitGroup) {
    ...
    resp, err := client.R().
        ...
        Get("/nvue_v1/vrf/default/router/rlb")
...
func (r CEOS) GetRoutes(wg *sync.WaitGroup) {
    ...
    client.SetBaseURL("https://" + r.Hostname + ":6026")
    client.SetBasicAuth(r.Username, r.Password)
